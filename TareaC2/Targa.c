...
//Para poder hacer operaciones directamente con el apuntador
...
//con % usamos el valor menos significativo y lo asignamos en la direccion mas pequeña mientras que con / lo asignamos al valor más grande
...
// Obtenemos el archivo, su estructura y obtenemos la info con un get
...
int main(void) {
   ...
   for(y = 0; y < header.height; y++)
	...
	// Open output file
   tga = fopen("pruebaluminosity.tga", "wb");
